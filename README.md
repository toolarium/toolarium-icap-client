...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.toolarium/toolarium-icap-client/1.3.6)](https://search.maven.org/artifact/com.github.toolarium/toolarium-icap-client/1.3.6/jar)
...
```groovy
dependencies {
    implementation "com.github.toolarium:toolarium-icap-client:1.3.6"
}
```
