...
public class ICAPLargeFileTest extends AbstractICAPClientTest {
     ...
     */
    @Test
    public void testLargeTextFileAllow204() throws IOException, ContentBlockedException {
     ...
     */
    @Test
    public void testLargeTextFile() throws IOException, ContentBlockedException {
        File file = new RandomGenerator().createRandomFile("build/large-scan-file.txt", 3 * 1024 * 1024, false, false);
        setAllow204(false);
     ...
     */
    @Test
    public void testLargeBinaryFileAllow204() throws IOException, ContentBlockedException {
     ...
     */
    @Test
    public void testLargeBinaryFile() throws IOException, ContentBlockedException {
        File file = new RandomGenerator().createRandomFile("build/large-scan-file.bin", 3 * 1024 * 1024, false, true);
        setAllow204(false);
     ...
     */
    @Test
    public void testLargeBinaryWithVirusFileAllow204() throws IOException, ContentBlockedException {
     ...
     */
    @Test
    public void testLargeBinaryWithVirusFile() throws IOException, ContentBlockedException {
        File file = new RandomGenerator().createRandomFile("build/large-scan-file-virus.bin", 3 * 1024 * 1024, true, false);
        try (FileOutputStream outputstream = new FileOutputStream(file, true)) {
            outputstream.write((byte)'\r');
            outputstream.write((byte)'\n');
